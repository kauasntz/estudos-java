...
public class HerancaTest02 {
    ...
    // 4 - Bloco de inicialiazação da superclasse é executado na ordem em que aparece
    ...
    // 8 - Bloco de inicialiazação da subclasse é executado na ordem em que aparece
    // 9 - Construtor é executado da subclasse

    public static void main(String[] args) {
        Funcionario funcionario = new Funcionario("King Crimson");
    }
}
